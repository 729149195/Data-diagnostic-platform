          ...
          <div class="aside-content">
            ...
            <el-card class="table" shadow="never" v-if="selectedButton === 'test'">
              <span style="display: flex; align-items: center; margin-bottom: 5px;">
                ...
                <el-switch class="test_table_switch" v-model="test_table_value"
                  style="--el-switch-on-color: #409EFF; --el-switch-off-color: #409EFF" active-text="通道类别"
                  inactive-text="异常类别" />
              </span>
          ...
          <el-main class="test_main" v-if="selectedButton === 'test'">
            <el-card class="data_exploration" shadow="never">
              <span style="display: flex; align-items: center; justify-content: space-between;">
                ...
                <span>采样率 <el-input-number v-model="sampling" :precision="2" :step="0.1" :max="10" /></span>
                <span>平滑度 <el-input-number v-model="smoothness" :precision="2" :step="0.1" :max="10" /></span>
                <el-switch v-model="test_channel_number"
                  style="--el-switch-on-color: #409EFF; --el-switch-off-color: #409EFF" active-text="多通道单行"
                  inactive-text="单通道多行" />
                <img src="../../public/image1.png" style="height: 30px;" alt="图例">
              ...
              <el-card class="two_right" shadow="never">
                <span style="display: flex; align-items: center; justify-content: space-between;">
                  ...
                  <el-switch v-model="test_result_switch"
                    ...
                    inactive-text="列表模式" />
                  <img src="../../public/image2.png" style="height: 20px;" alt="图例">
                  <el-button type="primary">
                    导出<el-icon class="el-icon--right">
                      <Upload />
                    </el-icon>
...
import VisChannelConfigTable from '@/components/VisChannelConfigTable.vue';
...
import HeatMapResult from '@/views/AnomalyLabelView/LabelResult/HeatMapResult.vue';
